...
//           <DialogClose asChild>
//             <button type="submit" onSubmit={handleDelete} className="px-4 py-2 rounded-md self-end bg-red-600 text-center flex justify-center items-center text-white font-semibold text-md hover:bg-red-500">
//               Yes
//             </button>
//           </DialogClose>
//         </DialogFooter>
